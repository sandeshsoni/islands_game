defmodule IslandsEngine.BoardTest do
  ...
  test "guess hit a coordinate" do
    {:ok, coordinate1} = Coordinate.new(1,1)
    {:ok, square_island} = Island.new(:square, coordinate1)
    {:ok, coordinate2} = Coordinate.new(5,2)
    {:ok, dot_island} = Island.new(:dot, coordinate2)
    ...
    {:hit, dot_island, :no_win, _board} = Board.guess(board,coordinate1)
  end

  test "guess last coordinate to win" do
    {:ok, coordinate1} = Coordinate.new(1,1)
    {:ok, square_island} = Island.new(:square, coordinate1)
    {:ok, coordinate2} = Coordinate.new(5,2)
    {:ok, dot_island} = Island.new(:dot, coordinate2)
    ...
    {:hit, dot_island, :no_win, board} = Board.guess(board,coordinate1)
    {:hit, dot_island, :no_win, board} = Board.guess(board,coordinate1)
  end
end
